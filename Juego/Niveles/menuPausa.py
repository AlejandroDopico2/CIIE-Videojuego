...
class PantallaPausa(Pantalla):
    def __init__(self, menu):
        ...
        RESUME_BUTTON = Button(image=pygame.image.load("Recursos/Play Rect.png"), pos=(640, 220),
                            text_input="RESUME", font=self.get_font(75), base_color="#d7fcd4", hovering_color="White")
        
        self.screenButtons.update({"RESUME_BUTTON":RESUME_BUTTON})
        
        OPTIONS_BUTTON = Button(image=pygame.image.load("Recursos/Play Rect.png"), pos=(640, 330),
        ...
        EXIT_BUTTON = Button(image=pygame.image.load("Recursos/Play Rect.png"), pos=(640, 440),
                            text_input="EXIT", font=self.get_font(75), base_color="#d7fcd4", hovering_color="White")
